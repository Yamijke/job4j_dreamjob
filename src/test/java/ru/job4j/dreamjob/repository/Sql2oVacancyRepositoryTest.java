...
public class Sql2oVacancyRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var expectedDate = vacancy.getCreationDate().truncatedTo(ChronoUnit.MINUTES);
        var actualDate = savedVacancy.getCreationDate().truncatedTo(ChronoUnit.MINUTES);
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var expectedDate = updatedVacancy.getCreationDate().truncatedTo(ChronoUnit.MINUTES);
        var actualDate = savedVacancy.getCreationDate().truncatedTo(ChronoUnit.MINUTES);
        assertThat(actualDate).isEqualTo(expectedDate);
        assertThat(savedVacancy)
                .usingRecursiveComparison()
